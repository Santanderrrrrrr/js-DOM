...
const ranDiv = document.createElement('div');
const ranDiv2 = document.createElement('div');
ranDiv.classList.add("atRandom")
ranDiv2.classList.add("atRandomBaby")
document.body.appendChild(ranDiv)

const h2s = document.querySelectorAll("li")
h2s.forEach((h)=>{
    h.addEventListener("click", function(){
        ranDiv.appendChild(ranDiv2)
